...
export default async function EventsPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-12">
      <h1 className="text-3xl font-black text-white mb-1">所有活動</h1>
      <p className="text-white/50 mb-10">每月 10–15 場，總有一場適合你</p>

      {active.length > 0 && (
        <section className="mb-14">
          <h2 className="text-lg font-bold text-white mb-5 border-l-4 border-white/50 pl-3">開放報名</h2>
      ...
      {ended.length > 0 && (
        <section>
          <h2 className="text-lg font-bold text-white/40 mb-5 border-l-4 border-white/20 pl-3">已結束活動</h2>
