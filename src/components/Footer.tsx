    ...
    <footer className="bg-warm-800 text-warm-100 py-10 mt-16">
      <div className="max-w-5xl mx-auto px-6 text-center">
        <div className="flex justify-center mb-3">
          <div className="w-12 h-12 rounded-full bg-warm-600 flex items-center justify-center overflow-hidden">
            <Image src="/logo.png" alt="領航里" width={48} height={48} className="scale-110" />
          </div>
        </div>
